...
def to_tensor(tensor, lib, force_unsigned=False):
    ...
    # print(type(tensor.shape), tensor.shape)  # <class 'torch.Size'> torch.Size([13, 4])
    # print(*tensor.shape)  # 13 4

    ndim = tensor.ndimension()
    shape = (ctypes.c_size_t * ndim)(*tensor.shape)  # <libinfiniop.utils.c_ulong_Array_2 object at 0x7fece8c9a3c0>
...
def rearrange_tensor(tensor,  # Size([13, 4])
                     new_strides  # (10, 1)
                     ):
    """
